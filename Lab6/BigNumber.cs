...
namespace Lab6
{
    public enum Sign { Minus = -1, Plus = 1}
    ...
    public class BigNumber
    {
        ...
        public static BigNumber Random(BigNumber min, BigNumber max)
        {
            ...
            while(true)
            {
                ...
                {
                    var tmp = rnd.Next(0, 10 - min.GetByte(i));
                    result.SetByte(i, (byte)(min.GetByte(i) + rnd.Next(0, 10 - min.GetByte(i))));
                }
        ...
        public static BigNumber Pow(int based, int pow)
        {
            BigNumber result = new BigNumber(based);
            BigNumber tmp = new BigNumber(based);
